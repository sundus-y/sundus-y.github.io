        ...
        render: function () {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'row' },
                    React.createElement(Store, { data: this.state.stores, onStoreSelect: this.handleStoreSelect }),
                    React.createElement(Item, { disabled: this.state.selectedStore == '-1' ? true : false, onItemSelect: this.handleItemSelect })
                ),
                React.createElement(Sale, { onReturn: this.handleReturnSaleItem, data: this.state.sales })
            );
        }
    });

    function renderReturnSalesApp(container) {
        ReactDOM.render(React.createElement(ReturnSalesApp, null), container[0]);
    }
    $(document).ready(function () {
        if ($('.return_sales_app').length != 0) {
            renderReturnSalesApp($('.return_sales_app'));
        }
    });
})();