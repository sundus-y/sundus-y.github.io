...
(function () {
    ...
    function bindSearchSelectEvent() {
        ...
        $('#search_item_field').on('autocompleteopen', function (event, object) {
            ...
            $('ul.ui-autocomplete').prepend("" + "<li class='autocomplete-header'>" + "<div class='row'>" + "<div class='col-sm-3'>Item Number</div>" + "<div class='col-sm-5'>Name</div>" + "<div class='col-sm-2'>Inventory</div>" + "<div class='col-sm-1'>Brand</div>" + "<div class='col-sm-1'>Origin</div>" + "</div>" + "</li>").css('width', '75%');
    ...
    var App = React.createClass({
        ...
        handleTransferItemCreate: function () {
            ...
            if (itemId != '') {
                ...
                var foundTransferItem = this.state.data.find(function (transferItem) {
                    return transferItem.item.id === itemId;
                });
        ...
        render: function () {
            ...
            main = React.createElement(
                ...
                React.createElement(
                    ...
                    null,
                    transferItems,
                    React.createElement(TransferItemFooter, {
    ...
    $(document).ready(function () {
        if ($('.transfer_items_app').length != 0) {
            render(false, $('.transfer_items_app'));
        }
        if ($('.transfer_items_show_app').length != 0) {
            render(true, $('.transfer_items_show_app'));
        }
    });
})();